...
function activate(context) {
        ...
        panel.webview.onDidReceiveMessage(async (message) => {
            ...
            if (message.command === 'sendPrompt') {
                ...
                try {
                    ...
                    const res = await (0, node_fetch_1.default)('http://localhost:3000/ask', {
                        method: 'POST',
    ...
    const askDisposable = vscode.commands.registerCommand('sable.askAI', async () => {
        ...
        if (!cachedWebviewPanel) {
            cachedWebviewPanel = vscode.window.createWebviewPanel('sableChat', 'Sable Chat', vscode.ViewColumn.Two, { enableScripts: true, retainContextWhenHidden: true });
